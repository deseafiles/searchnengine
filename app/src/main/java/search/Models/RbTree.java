...
public class RbTree {
    ...
    private List<Node> searchHelperByKey(Node node, String key) {
        ...
        result.addAll(searchHelperByKey(node.getLeft(), key));
        result.addAll(searchHelperByKey(node.getRight(), key));
    ...
    private List<Node> searchHelperByValue(Node node, String value) {
        ...
        String nodeValue = node.getValue() != null ? node.getValue().toString().toLowerCase() : "";
        String searchValue = value.toLowerCase();
       
        if (nodeValue.contains(searchValue)) {
            result.add(node);
        }
        
        result.addAll(searchHelperByValue(node.getLeft(), value));
        result.addAll(searchHelperByValue(node.getRight(), value));
